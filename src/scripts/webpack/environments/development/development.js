...
module.exports = {
  entry: {
    client: './Project/Hackathon.RandomPick/client/client.index.tsx',
  ...
  resolve: {
    ...
    alias: {
      dataprovideralias: path.resolve(process.cwd(), './Project/Hackathon.RandomPick/client/dataProvider/DataProvider.dev'),
