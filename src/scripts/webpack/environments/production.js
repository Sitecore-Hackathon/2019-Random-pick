...
module.exports = [
  {
    ...
    resolve: {
      ...
      alias: {
        dataprovideralias: path.resolve(process.cwd(), './Project/Hackathon.RandomPick/client/dataProvider/DataProvider.prod'),
    ...
    plugins: [
      ...
      new ExtractTextPlugin('./Project/Hackathon.RandomPick/client/build/styles.css'),
      new webpack.optimize.CommonsChunkPlugin({
        name: 'vendor.bundle',
        filename: 'Project\\Hackathon.RandomPick\\client\\build\\vendor.bundle.js',
      ...
      // new webpack.optimize.CommonsChunkPlugin({
      //   name: 'react.bundle',
      //   filename: 'Project\\Hackathon.RandomPick\\client\\build\\react.bundle.js',
      //   minChunks(module, count) {
      //     var context = module.context;
  ...
  //       {
  //         from: './Project/Hackathon.RandomPick/client/Assets/fonts/*',
  //         to: './Project/Hackathon.RandomPick/client/build/fonts/',
  //         flatten: true,
  //       },
  //     ]),
  //     new CopyWebpackPlugin([
  //       {
  //         from: './Project/Hackathon.RandomPick/client/Assets/*.*',
  //         to: './Project/Hackathon.RandomPick/client/build/',
  //         flatten: true,
  //       },
  //     ]),
  //   ],
