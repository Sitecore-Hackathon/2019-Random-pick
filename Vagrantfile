...
project = 'hackathon-randompick'
vagrant_root = File.dirname(__FILE__)
host_serialization_root = "#{vagrant_root}/src" # host opprating system, which is hosting Vagrant and VirtualBox
guest_serialization_root = '/inetpub/wwwroot/sc9.local/App_Data/unicorn-Hackathon-RandomPick' # VM that you creating

Vagrant.configure('2') do |config|
  config.vm.box = 'w16s-sc902'
  ...
  config.hostmanager.aliases = %w(sc9.local hackathon-randompick.local hackathon-randompick.sc9.local hackathon-randompick-local.azurewebsites.net)
